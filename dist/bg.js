...
let OPENED_POPUP = [];
((webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().browserAction) || (webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().action)).onClicked.addListener(async () => {
  ...
  if (OPENED_POPUP.length) {
    ...
    await webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.update(popupWindowId, { focused: true });
    await webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().tabs.highlight({ windowId: popupWindowId, tabs: 0 });
    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.update(popupWindowId, { drawAttention: true, ...appConfig }).then((w) => console.log(w));
    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.update(_parentId, { drawAttention: true, ...parentConfig }).then((w) => console.log(w));
  } else {
    webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.create({
      ...
      await webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.update(parentWindow.id, { ...parentConfig });
      OPENED_POPUP.push({
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_0___default().windows.onRemoved.addListener((id) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors.js"], () => (__webpack_require__("./src/bg/index.js")))
